...
```
## Result
![Stack](../../imgs/lab10/Stack.png)
![Queue](../../imgs/lab10/Queue.png)
...
class SinglyLinkedList:
    ...
    def remove_at(self, idx: int) -> Any:
        """Removes the element at index idx and returns its value."""
        if idx < 0 or idx >= self._size:
    ...
    def visualize(self) -> str:
        ...
        while current is not None:
            result_parts.append(f"{current}")  # use __repr__ Node
            current = current.next
...
if __name__ == "__main__":
    ...
    letters.append("D")
    letters.prepend("A")
    print(f"\nList of letters: {str(letters)}")  # List of letters
```
## Result
![linked_list](../../imgs/lab10/linked_list.png)